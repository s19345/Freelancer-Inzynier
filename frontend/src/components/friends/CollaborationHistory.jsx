            ...
            <Card sx={{maxWidth: 400, borderRadius: 3, boxShadow: 2}}>
                <CardContent>
                    ...
                    <Box sx={{display: "flex", justifyContent: "left", mb: 1}}>
                        <Typography variant="body2">Wspólne projekty</Typography>
                    ...
                    <Divider sx={{mb: 1}}/>
                    <Box sx={{display: "flex", justifyContent: "left", mb: 1}}>
                        <Typography variant="body2">Pierwszy wspólny projekt</Typography>
                        <Typography sx={{ml: 3}} variant="body2"
                    ...
                    <Box sx={{display: "flex", justifyContent: "left", mb: 1}}>
                        <Typography variant="body2">Ostatni wspólny projekt</Typography>
                        <Typography sx={{ml: 3}} variant="body2"
                    ...
                    <Box sx={{display: "flex", justifyContent: "left"}}>
                        <Typography variant="body2">Godzin spêdzonych nad wspólnymi projektami</Typography>
