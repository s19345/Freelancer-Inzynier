# Generated by Django 5.2 on 2025-07-25 09:20
...
class Migration(migrations.Migration):
    dependencies = [
        ('users', '0005_customuser_location_customuser_phone_number_and_more'),
    ]
        ...
        migrations.AlterField(
            ...
            field=models.CharField(blank=True,
                                   choices=[('Africa/Abidjan', 'Africa/Abidjan'), ('Africa/Accra', 'Africa/Accra'),
                                            ...
                                            ('America/New_York', 'America/New_York'), ('America/Nome', 'America/Nome'),
                                            ('America/Noronha', 'America/Noronha'),
                                            ('America/North_Dakota/Beulah', 'America/North_Dakota/Beulah'),
                                            ('America/North_Dakota/Center', 'America/North_Dakota/Center'),
                                            ('America/North_Dakota/New_Salem', 'America/North_Dakota/New_Salem'),
                                            ('America/Nuuk', 'America/Nuuk'), ('America/Ojinaga', 'America/Ojinaga'),
                                            ...
                                            ('America/Thule', 'America/Thule'), ('America/Tijuana', 'America/Tijuana'),
                                            ...
                                            ('Asia/Atyrau', 'Asia/Atyrau'), ('Asia/Baghdad', 'Asia/Baghdad'),
                                            ('Asia/Bahrain', 'Asia/Bahrain'), ('Asia/Baku', 'Asia/Baku'),
                                            ('Asia/Bangkok', 'Asia/Bangkok'), ('Asia/Barnaul', 'Asia/Barnaul'),
                                            ('Asia/Beirut', 'Asia/Beirut'), ('Asia/Bishkek', 'Asia/Bishkek'),
                                            ('Asia/Brunei', 'Asia/Brunei'), ('Asia/Chita', 'Asia/Chita'),
                                            ('Asia/Colombo', 'Asia/Colombo'), ('Asia/Damascus', 'Asia/Damascus'),
                                            ...
                                            ('Asia/Hebron', 'Asia/Hebron'), ('Asia/Ho_Chi_Minh', 'Asia/Ho_Chi_Minh'),
                                            ('Asia/Hong_Kong', 'Asia/Hong_Kong'), ('Asia/Hovd', 'Asia/Hovd'),
                                            ('Asia/Irkutsk', 'Asia/Irkutsk'), ('Asia/Jakarta', 'Asia/Jakarta'),
                                            ('Asia/Jayapura', 'Asia/Jayapura'), ('Asia/Jerusalem', 'Asia/Jerusalem'),
                                            ('Asia/Kabul', 'Asia/Kabul'), ('Asia/Kamchatka', 'Asia/Kamchatka'),
                                            ('Asia/Karachi', 'Asia/Karachi'), ('Asia/Kathmandu', 'Asia/Kathmandu'),
                                            ('Asia/Khandyga', 'Asia/Khandyga'), ('Asia/Kolkata', 'Asia/Kolkata'),
                                            ('Asia/Krasnoyarsk', 'Asia/Krasnoyarsk'),
                                            ('Asia/Kuala_Lumpur', 'Asia/Kuala_Lumpur'),
                                            ('Asia/Kuching', 'Asia/Kuching'), ('Asia/Kuwait', 'Asia/Kuwait'),
                                            ('Asia/Macau', 'Asia/Macau'), ('Asia/Magadan', 'Asia/Magadan'),
                                            ('Asia/Makassar', 'Asia/Makassar'), ('Asia/Manila', 'Asia/Manila'),
                                            ('Asia/Muscat', 'Asia/Muscat'), ('Asia/Nicosia', 'Asia/Nicosia'),
                                            ...
                                            ('Asia/Qyzylorda', 'Asia/Qyzylorda'), ('Asia/Riyadh', 'Asia/Riyadh'),
                                            ...
                                            ('Asia/Tomsk', 'Asia/Tomsk'), ('Asia/Ulaanbaatar', 'Asia/Ulaanbaatar'),
                                            ...
                                            ('Europe/Athens', 'Europe/Athens'), ('Europe/Belgrade', 'Europe/Belgrade'),
                                            ...
                                            ('Europe/Kirov', 'Europe/Kirov'), ('Europe/Kyiv', 'Europe/Kyiv'),
                                            ...
                                            ('Europe/Ulyanovsk', 'Europe/Ulyanovsk'), ('Europe/Vaduz', 'Europe/Vaduz'),
                                            ...
                                            ('Europe/Zurich', 'Europe/Zurich'), ('GMT', 'GMT'),
                                            ...
                                            ('Pacific/Saipan', 'Pacific/Saipan'), ('Pacific/Tahiti', 'Pacific/Tahiti'),
                                            ('Pacific/Tarawa', 'Pacific/Tarawa'),
                                            ('Pacific/Tongatapu', 'Pacific/Tongatapu'),
                                            ('Pacific/Wake', 'Pacific/Wake'), ('Pacific/Wallis', 'Pacific/Wallis'),
                                            ('US/Alaska', 'US/Alaska'), ('US/Arizona', 'US/Arizona'),
                                            ('US/Central', 'US/Central'), ('US/Eastern', 'US/Eastern'),
                                            ('US/Hawaii', 'US/Hawaii'), ('US/Mountain', 'US/Mountain'),
                                            ('US/Pacific', 'US/Pacific'), ('UTC', 'UTC')],
                                   default=django.utils.timezone.get_current_timezone_name, max_length=50, null=True),
        ),
    ]
